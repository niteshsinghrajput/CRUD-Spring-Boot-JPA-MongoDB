...
public class BundleComponents implements Serializable
{
    ...
    private final static long serialVersionUID = -5785572245794206926L;
	...
	public String toString() {
		return "BundleComponents [isAssortment=" + isAssortment + ", isKitMaster=" + isKitMaster + ", isStandardItem="
				+ isStandardItem + ", isComponent=" + isComponent + ", additionalProperties=" + additionalProperties
				+ "]";
	}
