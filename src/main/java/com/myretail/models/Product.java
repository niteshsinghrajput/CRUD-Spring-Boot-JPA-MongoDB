...
public class Product implements Serializable
{
    ...
    private final static long serialVersionUID = 5816827328008410852L;
	...
	public String toString() {
		return "Product [deepRedLabels=" + deepRedLabels + ", availableToPromiseNetwork=" + availableToPromiseNetwork
				+ ", item=" + item + ", additionalProperties=" + additionalProperties + "]";
	}
